...
const i$ = {
  ...
  iW = ({ size: e = 'md', color: t = 'light' }) =>
    /*#__PURE__*/ (0, A.jsx)('span', {
      className: `loading loading-spinner ${i$.size[e]} ${i$.color[t]}`,
    }),
  iH = [
  ...
  iq = () => iH[Math.floor(Math.random() * iH.length)];
var P = L('acw62');
L('acw62');
const iK = ({
  icon: e,
...
const iY = ({ background: e = 'none', align: t = 'horizontal', stats: n }) =>
  /*#__PURE__*/ (0, A.jsx)('div', {
    className: `stats shadow ${iG.background[e]} ${iG.align[t]}`,
    children: n.map((e, t) =>
      /*#__PURE__*/ (0, A.jsxs)(
        'div',
        {
          className: `stat ${e.justify ? iG.justify[e.justify] : ''}`,
          children: [
            e.figure && e.figure,
            /*#__PURE__*/ (0, A.jsx)('div', {
              className: `${
                e.titleColor ? iG.titleColor[e.titleColor] : iG.titleColor.none
              } ${e.titleSize ? iG.titleSize[e.titleSize] : iG.titleSize.md}`,
              children: e.title,
            }),
            /*#__PURE__*/ (0, A.jsx)('div', {
              className: `${
                e.valueColor ? iG.valueColor[e.valueColor] : iG.valueColor.none
              } ${e.valueSize ? iG.valueSize[e.valueSize] : iG.valueSize.lg}`,
              children: e.value,
            }),
            /*#__PURE__*/ (0, A.jsx)('div', {
              className: `${
                e.descriptionColor
                  ? iG.descriptionColor[e.descriptionColor]
                  : iG.descriptionColor.none
              } ${
                e.descriptionSize
                  ? iG.descriptionSize[e.descriptionSize]
                  : iG.descriptionSize.sm
              }`,
...
const iX = ({ rowClass: e, data: t }) =>
  ...
  iJ = ({ order_id: e, table: t, items: n, onClose: r }) => {
    let [a, o] = iL(iI),
      l = (t) => {
  ...
  i2 =
      ...
      },
      {
        ...
        element: /*#__PURE__*/ (0, A.jsx)(() => {
          ...
          let [e, t] = (0, P.useState)(),
            ...
            a = iN(iO),
            o = async () => {
              let e = await fetch('http://localhost:2023/api/menu-items'),
                t = await e.json();
              return t;
            };
          (0, P.useEffect)(() => {
     ...
     */ (function (e) {
       ...
       */ async function et(t, n, r) {
        ...
        n.revalidate && (T = !0);
        let d = V(t.location, n.location, { _isRedirect: !0 });
        if ((U(d, 'Expected a location on the redirect navigation'), l)) {
          ...
          if (t) {
            s ? o.location.replace(n.location) : o.location.assign(n.location);
            return;
          }
        } // There's no need to abort on redirects, since we don't detect the
        // redirect until the action/loaders have settled
        a = null;
        let f = !0 === s ? g.Replace : g.Push,
          { formMethod: p, formAction: h, formEncType: m } = t.navigation;
        !i && !u && p && h && m && (i = eV(t.navigation)); // If this was a 307/308 submission we want to preserve the HTTP method and
        // re-submit the GET/POST/PUT/PATCH/DELETE as a submission navigation to the
        // redirected location
        let v = i || u;
        if (eu.has(n.status) && v && eD(v.formMethod))
          await G(f, d, {
            submission: D({}, v, { formAction: n.location }), // Preserve this flag across redirects
          ...
          await G(f, d, {
            ...
            fetcherSubmission: u, // Preserve this flag across redirects
            preventScrollReset: E,
          });
        }
      }
...
} //# sourceMappingURL=index.51123455.js.map
